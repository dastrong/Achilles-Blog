        ...
        <section className="index-cover">
          <div className="imgs">
            {Object.keys(imgs).map((file: 'image1' | 'image2' | 'image3') => {
              ...
              const name = img.originalName.slice(
                0,
                img.originalName.length - 5
              );
        ...
        <section className="index-content" style={{ height: '700px' }}>
          ...
          <div className="about-container">
            ...
            <p>
              ...
              Cupiditate, eius quo ad dolor quaerat corporis, voluptatem ratione
              quasi quae cumque provident nihil? Magni labore maxime, illo
              fugiat maiores deleniti nam.
            </p>
            <p>
